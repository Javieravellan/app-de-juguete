...
class Example9 extends Example {
  ...
  Widget build(BuildContext context) {
    return ConstrainedBox(
      ...
      child: Container(color: rojo, width: 10, height: 10),
    );
  }
}
...
class Example11 extends Example {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: ConstrainedBox(
        constraints: BoxConstraints(minWidth: 70, minHeight: 70, maxWidth: 150, maxHeight: 150),
        child: Container(color: rojo, width: 1000, height: 1000),
      ),
    );
  }
}
...
class Example12 extends Example {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: ConstrainedBox(
        constraints: BoxConstraints(minWidth: 70, minHeight: 70, maxWidth: 150, maxHeight: 150),
        child: Container(color: rojo, width: 100, height: 100),
      ),
    );
  }
}
...
class Example13 extends Example {
  ...
  Widget build(BuildContext context) {
    return UnconstrainedBox(
      child: Container(color: rojo, width: 20, height: 50),
    );
  }
}
...
class Example14 extends Example {
  ...
  Widget build(BuildContext context) {
    return UnconstrainedBox(
      child: Container(color: rojo, width: 4000, height: 50),
    );
  }
}
...
class Example23 extends Example {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Container(color: rojo, child: Text('Hello!', style: big)),
        Container(color: verde, child: Text('Goodbye!', style: big)),
      ],
    );
  }
}
      ...
      children: [
        Expanded(
            child: Container(
                color: rojo,
                child: Text('This is a very long text that won\'t fit the line.', style: big))),
        Expanded(child: Container(color: verde, child: Text('Goodbye!', style: big))),
      ],
    );
  }
}
      ...
      children: [
        Flexible(
            child: Container(
                color: rojo,
                child: Text('This is a very long text that won\'t fit the line.', style: big))),
        Flexible(child: Container(color: verde, child: Text('Goodbye!', style: big))),
      ],
    );
  }
}
